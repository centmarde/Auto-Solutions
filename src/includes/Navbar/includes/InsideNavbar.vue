    ...
    <div class="container-fluid">
      ...
      >
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <button> <router-link to="/UserInfo" class="nav-link" >{{username}}</router-link></button>
           
          </li>
          <li class="nav-item">
            <button> <router-link to="/CarMenu" class="nav-link" @click="closeMenu">SERVICES</router-link></button>
           
          </li>
          <li class="nav-item me-5">
            <button> <router-link to="/" class="nav-link" @click="handleLogout">LOGOUT</router-link></button>
