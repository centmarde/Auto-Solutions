                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ul class="dropdown-menu">
                            <li><router-link to="/Supra" class="dropdown-item" @click="closeMenu">2024 Toyota GR Supra</router-link></li>
                            <li><router-link to="/Honda" class="dropdown-item" @click="closeMenu">2024 HONDA CIVIC</router-link>
                            </li>
                        </ul>
                    ...
                    <div class="col mt-3 d-flex justify-content-end">
                        <button class="custom-button ms-1" @click="BodyButton">BODY</button>
                        <button class="custom-button ms-1" @click="BackButton">BACK</button>
                        <button class="custom-button ms-1" @click="TireButton">TIRES</button>
                        <button class="custom-button ms-1" @click="InteriorButton">INTERIOR</button>
